...
Fit may go below the manual legibility floor to include the whole scene. Zooming in from that overview is gradual; manual zoom-out cannot shrink it further. Hover coordinate tooltips counter-scale to their normal screen size, and `⊞` distinguishes the lattice span from tensor shape.
